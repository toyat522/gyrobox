...
**********************************************************************
*/
void Display_WriteM8_A1(uint8 *wrData, int numbytes){
  GUI_USE_PARA(wrData); 
  GUI_USE_PARA(numbytes);
}

void Display_WriteM8_A0(uint8 *wrData, int numbytes){
  GUI_USE_PARA(wrData); 
  GUI_USE_PARA(numbytes);
}

void Display_ReadM8_A1(uint8 *rdData, int numbytes){
  GUI_USE_PARA(rdData); 
  GUI_USE_PARA(numbytes);
}

void Display_Write8_A0(uint8 byte){
  GUI_USE_PARA(byte);
}

void Display_Write8_A1(uint8 byte){
  GUI_USE_PARA(byte);
}
...
void LCD_X_Config(void) 
{
  ...
  if (LCD_GetSwapXY()) {
    ...
    LCD_SetSizeEx (0, VXSIZE_PHYS, VYSIZE_PHYS);
