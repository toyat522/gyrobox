...
*/
...
#else
  #if (LCD_SWAP_XY)
    #error Cache can only be used without swapping mode!
  #endif
#endif
#ifndef   LCD_SET_ORG
  ...
  #if   (LCD_CONTROLLER == 66702)                               /* Solomon SSD1289 */
    #define LCD_NUM_DUMMY_READS 1
  #elif (LCD_CONTROLLER == 66705) && (LCD_USE_PARALLEL_16 == 0) /* Samsung S6D0129, Renesas R61505 */
    #define LCD_NUM_DUMMY_READS 1
  ...
  #elif (LCD_CONTROLLER == 66709)                               /* Novatek NT39122, Renesas R61516, Sitronix ST7628, Sitronix ST7637, Epson S1D19122 */
    #define LCD_NUM_DUMMY_READS 1
  #elif (LCD_CONTROLLER == 66712)                               /* Himax HX8347 */
    #define LCD_NUM_DUMMY_READS 1
  #else
    #define LCD_NUM_DUMMY_READS 2 /* If paralell interface is used most of 
...
#elif (LCD_CONTROLLER == 66772) || /* Hitachi HD66772, Samsung S6D0117, Sitronix ST7712, Himax HX8301 */ \
...
#elif (LCD_CONTROLLER == 66701)    /* Renesas R63401, Renesas R61509, OriseTech SPFD5420A */
  /* Register definitions */
...
#elif (LCD_CONTROLLER == 66702)    /* Solomon SSD1289 */
  /* Register definitions */
...
#elif (LCD_CONTROLLER == 66705)    /* Samsung S6D0129, Renesas R61505 */
  /* Register definitions */
  #define REG_INC_MODE      0x03   /* - Entry mode */
...
#elif (LCD_CONTROLLER == 66708)    /* Ilitek ILI9320, Ilitek ILI9325, LG Electronics LGDP4531, OriseTech SPFD5408 */
  /* Register definitions */
  #define REG_INC_MODE      0x03   /* - Entry mode */              
...
#elif (LCD_CONTROLLER == 66711)    /* Epson S1D13743 */
  /* Register definitions */
...
*/
    ...
    (LCD_CONTROLLER == 66772) || /* Hitachi HD66772, Samsung S6D0117, Sitronix ST7712, Himax HX8301 */ \
    (LCD_CONTROLLER == 66789) || /* Hitachi HD66789 */ \
    (LCD_CONTROLLER == 66701) || /* Renesas R63401, R61509, OriseTech SPFD5420A */ \
    (LCD_CONTROLLER == 66702) || /* Solomon SSD1289 */ \
    (LCD_CONTROLLER == 66703) || /* Toshiba JBT6K71 */ \
    (LCD_CONTROLLER == 66705) || /* Samsung S6D0129, Renesas R61505 */ \
    (LCD_CONTROLLER == 66708)    /* Ilitek ILI9320, Ilitek ILI9325, LG Electronics LGDP4531, OriseTech SPFD5408 */
  #if   (!LCD_MIRROR_X && !LCD_MIRROR_Y && !LCD_SWAP_XY)
  ...
  #endif
#elif (LCD_CONTROLLER == 66709) || /* Novatek NT39122, Renesas R61516, Sitronix ST7628, Sitronix ST7637, Epson S1D19122 */ \
      (LCD_CONTROLLER == 66712)    /* Himax HX8347 */
  #if   (!LCD_MIRROR_X && !LCD_MIRROR_Y && !LCD_SWAP_XY)
    #define INC_MODE_LB ________
  #elif ( LCD_MIRROR_X && !LCD_MIRROR_Y && !LCD_SWAP_XY)
...
*/
#if LCD_CACHE
  static U16 _aVRam[CACHE_OFFSET * LCD_VYSIZE];
...
*       _WriteM_A1
*/
static void _WriteM_A1(char * p, int NumBytes) {
  #if LCD_CACHE
    LCD_CLRCS();
    LCD_WRITEM((char*)&_StartByteWriteData, 1);
...
*       _WriteM_A0
*/
static void _WriteM_A0(char * p, int NumBytes) {
...
*       _ReadM_A1
*/
static void _ReadM_A1(char * p, int NumBytes) {
  LCD_CLRCS();
  LCD_WRITEM((char*)&_StartByteReadData, 1);
...
static U16 _ReadU16_A1(void) {
  ...
  #else
    U16 Data;
    READM_A1((char *)_aPair, 2 + LCD_NUM_DUMMY_READS);
...
static U16 _ReadU16_A1(void) {
  ...
  #else
    /*
      Please note that the HX8347 does only support a color depth
      of 16bpp in combination with a 16 bit data bus interface.
      The 8 bit bus can not be used with this version of the driver.
    */
    #error The HX8347 does not support a color depth of 16bpp with an 8 bit bus interface!
  #endif
}
...
static U16 _ReadU16_A1(void) {
  U8 aData[3 + LCD_NUM_DUMMY_READS];
  U16 Result;
  READM_A1((char *)aData, 3 + LCD_NUM_DUMMY_READS);
...
static void _CalcCacheAddr(void) {
  ...
  #else
    _Addr = _yPos * CACHE_OFFSET + _xPos;
  #endif
}
...
static void _WriteData(unsigned PixelIndex) {
  #if LCD_CACHE
    #if LCD_USE_PARALLEL_16
      _aVRam[_Addr] = PixelIndex;
    #else
      _aVRam[_Addr] = (PixelIndex >> 8) | (PixelIndex << 8);
    #endif
    _IncrementCursor();
  #else
    #if LCD_USE_PARALLEL_16
    ...
    while (NumPixels--) {
      ...
      _IncrementCursor();
        ...
        while (NumPixels) {
          ...
          WRITEM_A1((char *)&_WriteBuffer[1], NumWords * 2);
          NumPixels -= NumWords;
        }
      #endif
    #else
    ...
    while (NumPixels--) {
      ...
      WRITEM_A1(pData, NumPixels);
        ...
        while (NumPixels--) {
          U16 PixelIndex;
          PixelIndex = *pData++;
          _WriteBuffer[1] = PixelIndex >> 8;
          _WriteBuffer[2] = PixelIndex & 0xFF;
          WRITEM_A1((char *)&_WriteBuffer[1], 2);
        }
      #else
      {
        U8 aBuffer[2];
...
*       _SetPhysRAMAddr
*/
#elif (LCD_CONTROLLER == 66701) || /* Renesas R63401, R61509, OriseTech SPFD5420A */ \
      (LCD_CONTROLLER == 66702) || /* Solomon SSD1289 */ \
      (LCD_CONTROLLER == 66703) || /* Toshiba JBT6K71 */ \
      (LCD_CONTROLLER == 66708)    /* Ilitek ILI9320, Ilitek ILI9325, LG Electronics LGDP4531, OriseTech SPFD5408 */
static void _SetPhysRAMAddr(int x, int y) {
...
static void _SetRect(int x0, int y0, int x1, int y1) {
    ...
    /* Use easy version if default orientation is used */
    _SET_CACHE_RECT(x0, y0, x1, y1);
    #if   (LCD_CONTROLLER == 66701) || /* Renesas R63401, R61509, OriseTech SPFD5420A */ \
          (LCD_CONTROLLER == 66703) || /* Toshiba JBT6K71 */ \
          (LCD_CONTROLLER == 66708)    /* Ilitek ILI9320, Ilitek ILI9325, LG Electronics LGDP4531, OriseTech SPFD5408 */
...
*       _SetPhysRAMAddr and _SetRect for the following display controllers:
*
*       - Samsung S6D0129, Renesas R61505
*/
/*********************************************************************
*
*       _SetPhysRAMAddr
...
*/
#if LCD_CACHE
static void _SendCacheRect(void) {
  #if (!LCD_MIRROR_X && !LCD_MIRROR_Y && !LCD_SWAP_XY)
    U16 * pCache;
    int NumBytes, y;
    #if LCD_SUPPORT_CACHECONTROL
    ...
    NumBytes = _x1 - _x0 + 1;
      ...
      NumBytes <<= 1;
    #endif
    pCache = &_aVRam[CACHE_OFFSET * _y0 + _x0];
    for (y = _y0; y <= _y1; pCache += CACHE_OFFSET, y++) {
      #if (LCD_USE_PARALLEL_16)
    ...
    U32 NumPixels;
    _CalcCacheEdge();
    NumPixels = (U32)(_x1 - _x0 + 1) * (U32)(_y1 - _y0 + 1);
    while (NumPixels--) {
      #if (LCD_USE_PARALLEL_16)
        WRITEM_A1((U16 *)&_aVRam[_Addr], 1);
      #else
        WRITEM_A1((U8 *)&_aVRam[_Addr], 2);
      #endif
      _IncrementCursor();
    }
  #endif
...
static void  _DrawBitLine1BPP(int x, int y, U8 const GUI_UNI_PTR *p, int Diff, int xsize, const LCD_PIXELINDEX*pTrans) {
  ...
  case LCD_DRAWMODE_XOR:
    do {
      if (*p & (0x80 >> Diff)) {
        int Pixel = GET_PIXEL_INDEX(x, y);
        SET_PIXEL_INDEX(x, y, LCD_NUM_COLORS - 1 - Pixel);
      }
      x++;
      if (++Diff == 8) {
        Diff = 0;
...
*/
#define LCD_DELAY(Cnt) { volatile U32 i, j; j = Cnt << 8; for (i = 0; i < j; i++); }
int  LCD_L0_Init(void) {
  ...
  */
  ...
  #elif (LCD_CONTROLLER == 66704) || /* Sharp LCY-A06003 */ \
        (LCD_CONTROLLER == 66706) || /* MagnaChip D54E4PA7551 */ \
        (LCD_CONTROLLER == 66709) || /* Novatek NT39122, Renesas R61516, Sitronix ST7628, Sitronix ST7637, Epson S1D19122 */ \
        (LCD_CONTROLLER == 66712)    /* Himax HX8343 */
...
void LCD667XX_c(void);
void LCD667XX_c(void) { } /* avoid empty object files */
